...
def scrape_discord_server(
    guild_id: str, headers: Dict, limit: int = DEFAULT_LIMIT
) -> None:
    """
    ...
    print(
        f"Done scraping up to {limit} messages from all text channels in guild {guild_id}."
    )
